        ...
        <section className="bg-white text-black py-20">
            ...
            <div className="max-w-4xl mx-auto px-6 relative">
                ...
                <div className="text-center mt-16">
                    <a href="#_" class="relative bg-white inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-black transition duration-300 ease-out border-2 border-blue-400 rounded-full shadow-md group">
                        ...
                        <span class="absolute flex items-center justify-center w-full h-full text-blue-400 transition-all duration-300 transform group-hover:translate-x-full font-bold text-lg ease">Get Started</span>
                        <span class="relative invisible font-bold">Button Text</span>
                    </a>
                </div>
            </div>
        </section>
