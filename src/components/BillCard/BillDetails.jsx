...
const BillDetails = () => {
    ...
    return (
        <div>
            <div className="flex flex-col sm:flex-row gap-10 md:gap-15 lg:gap-20 border-2 bg-gray-600 text-white border-gray-300 rounded-xl shadow-sm py-8 px-20 hover:shadow-md transition-shadow max-w-max mx-auto">
                ...
                <div className='flex flex-col justify-between'>
                    ...
                    <div className='items-center space-y-2'>
                        ...
                        <button className='text-lg px-10 btn btn-neutral shadow-none rounded-xl hover:bg-white hover:text-black border-2 border-black '>Pay Bill</button>
                    </div>
                </div>
            </div>
        </div >
