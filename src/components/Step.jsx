...
const Step = ({ step, index }) => {
    return (
        <div className={`mb-8 flex items-center justify-between gap-10 w-full ${index % 2 === 0 ? 'flex-row-reverse' : ''}`}>
            <div
                className="order-2 md:w-5/12 backdrop-blur-sm bg-gray-900 text-white p-6 rounded-lg shadow-xl"
            >
